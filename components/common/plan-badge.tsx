...
export default async function PlanBadge(){ 
    ...
    return (
        <Badge 
            variant={'outline'}
            className={cn('ml-2 bg-linear-to-r from-amber-100 to-amber-200 border border-amber-300 hidden lg:flex flex-row items-center', 
                !priceId && 'from-red-100 to-red-300'
            )}>
